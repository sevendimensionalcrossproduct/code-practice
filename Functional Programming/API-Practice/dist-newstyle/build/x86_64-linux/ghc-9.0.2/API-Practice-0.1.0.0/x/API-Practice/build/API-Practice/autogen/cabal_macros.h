...
/* package API-Practice-0.1.0.0 */
#ifndef VERSION_API_Practice
#define VERSION_API_Practice "0.1.0.0"
#endif /* VERSION_API_Practice */
#ifndef MIN_VERSION_API_Practice
#define MIN_VERSION_API_Practice(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "API-Practice-0.1.0.0-inplace-API-Practice"
